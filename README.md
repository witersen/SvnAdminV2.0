...
```
docker run -d --name svnadmintemp -p 80:80 -p 3690:3690 --privileged witersencom/svnadmin:2.5.5
```
...
```
docker run -d --name svnadmintemp --privileged witersencom/svnadmin:2.5.5 /usr/sbin/init
```
...
```
cd /var/www/html/ && wget https://gitee.com/witersen/SvnAdminV2.0/releases/download/2.5.5/2.5.5.zip
